...
public class CouponController {
    ...
    @PostMapping("/issue")
    public ResponseEntity<CouponDto.Response> issueCoupon(
            @RequestBody CouponDto.IssueRequest request
    ) {
    ...
    public ResponseEntity<CouponDto.Response> useCoupon(
        ...
        return ResponseEntity.ok(CouponDto.Response.from(couponService.useCoupon(couponId, request.orderId())));
    }
